...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col pb-10">
      ...
      <section className="px-6 py-10 md:py-13">
      ...
      <section className="px-4 mt-4 md:px-8 md:mt-8 ">
        <div className="md:max-w-7xl md:mx-auto ">
          <div className="bg-brand-card rounded-2xl p-4 md:p-6 md:rounded-3xl flex items-center justify-between gap-4 md:gap-8">
