...
import { MOCK_PRODUCTS } from "../figma-brivan-sabor/src/app/data";
    ...
    <div className="flex flex-col bg-brand-black min-h-[calc(100vh-80px)] px-6 py-8">
      ...
      {items.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center gap-6 py-20">
          ...
          <Link
            to="/category/all"
            className="bg-brand-gold text-brand-black px-8 py-3 rounded-xl font-semibold"
          >
            Ver Cardápio
          </Link>
        </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-6">
            {items.map((item, idx) => (
              <div
                key={idx}
                className="flex gap-4 bg-[#1A1A1A] p-4 rounded-2xl border border-transparent hover:border-brand-soft-black transition-all"
              >
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div className="flex justify-between items-start">
                    ...
                    <button
                      ...
                      className="text-[#bdbdbd] hover:text-brand-destructive transition-colors p-1"
                    >
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <div className="flex items-center gap-4 bg-brand-black rounded-lg px-3 py-1 border border-brand-soft-black">
                      <button
                        ...
                        className="text-brand-gold hover:text-brand-warm-gold"
                      >
          ...
          {/* Order Summary */}
          <div className="lg:w-[400px] bg-[#1A1A1A] p-6 rounded-2xl h-fit border border-brand-soft-black">
            ...
            <Link
              to="/checkout"
              className="w-full bg-brand-gold text-brand-black font-semibold rounded-xl py-4 flex items-center justify-center uppercase tracking-widest hover:bg-brand-warm-gold transition-colors"
            >
              Finalizar Pedido
            </Link>
          </div>
